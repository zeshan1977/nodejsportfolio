...
const props = {
  ...
  schema: {type:String, default:'reference'},
...
class Reference extends Document {
	...
	static convertToJson(references){
	...
	*/
	...
	static findByIdAndUpdate(id, params){
		return Reference.findOneAndUpdate({_id:id}, params, {upsert:true})
	}

	static findByIdAndRemove(id){
		return Reference.findOneAndDelete({_id:id})
	}
}
