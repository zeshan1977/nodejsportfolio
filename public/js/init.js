...
function arlo_tm_animate_text(){
	...
	var animateSpan			= jQuery('.arlo_tm_animation_text_word');
		...
		animateSpan.typed({
			// Mohammed strings: ["Freelancer", "UI/UX Designer", "Web Developer"],
			strings: ["Linux System Engineer", "Technical Requirements Analyst","General Developer(QA,Integration,Back-End,serverside)"],
			loop: true,
			startDelay: 1e3,
			backDelay: 2e3
		});
